...
line_bot_api = LineBotApi('mIOW7SSdWZHTbrFq9ZZBQdytyb5JO9KaCYT9A6uzw/FHdu8nuusFh2YnNLIf/qt+TdWEPDo0DpDKZzCn8yZknNsOWBrG3gmgNt01s2lkfs4T6UBzhXTmI9Al7ERMPr0o+0obosBIgZdVVEt9vx6TGgdB04t89/1O/w1cDnyilFU=')
# Channel Secret
handler = WebhookHandler('62e9015c564529ac5c3dafe828ccfef5')
#===========[ NOTE SAVER ]=======================
notes = {}
...
#=====[ VIDEOS MESSAGE ]==========
        ...
        vidclipthai = requests.get("https://ru-4569f-default-rtdb.asia-southeast1.firebasedatabase.app/GO"+str(random.randint(1, 7))+"/"+str(random.randint(1, 150))+".json")
        text = vidclipthai.text
        data = json.loads(text)
        x_image = data['splash']
        x_title = data['splashtext']
        x_vpath = data['src']
        message = VideoSendMessage(
        original_content_url = x_vpath,
        preview_image_url = x_image
        )
        line_bot_api.reply_message(event.reply_token, message)

#=====[ CLIPTHAI MESSAGE ]==========
    elif text == 'clipthailist':
        message = TemplateSendMessage(
            alt_text='OTHER MENU',
            template=CarouselTemplate(
                columns=[
